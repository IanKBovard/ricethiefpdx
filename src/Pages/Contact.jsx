    ...
    <div className='flex flex-wrap justify-between'>
      ...
      <div className='mb-8 lg:mb-0'>
        ...
        <a
          ...
          target='_blank'
          className='text-brand-black flex flex-row items-center group'>
          <svg
            className='w-6 h-6 opacity-100 md:opacity-60 group-hover:opacity-100'
            fill='currentColor'
            viewBox='0 0 24 24'>
            <path
              fillRule='evenodd'
        ...
        <a
          ...
          <svg
            ...
            className='w-6 h-6 stroke-2 md:stroke-1 group-hover:stroke-2'
            fill='none'
            viewBox='0 0 24 24'
            stroke='currentColor'
            strokeLinecap='round'
