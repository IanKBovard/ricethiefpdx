  ...
  <section className='antialiased'>
    <div className='max-w-screen-xl px-4 py-8 mx-auto lg:px-6 sm:py-16 lg:py-24'>
      <div className='max-w-3xl mx-auto text-center'>
        <h2 className='text-4xl font-extrabold leading-tight tracking-tight text-brand-black '>
          Let's connect
        </h2>
      </div>
        ...
        <div className='col-span-1'>
          <div className='flex flex-row items-center hover:underline'>
            ...
            <a
              ...
              target='_blank'
              className='text-brand-black'>
              <span className='text-2xl ml-1.5'>ricethiefpdx</span>
            </a>
          </div>
          <div className='mt-2 flex flex-row items-center hover:underline'>
            <a
